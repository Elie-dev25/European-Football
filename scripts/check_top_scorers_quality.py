...
CRITICAL_COLUMNS = {"LEAGUE_ID", "SEASON", "TEAM_ID", "PLAYER_ID", "GOALS_TOTAL"}


def check_top_scorers_quality():
    with get_snowflake_connection() as conn:
        raw_count = get_row_count(
            conn, DATABASE, "RAW", "TOP_SCORERS",
            where="""team_id IN (
    ...
    print(f"RAW.TOP_SCORERS (filtré aux équipes de RAW.FIXTURES) : {raw_count} lignes")
...
if __name__ == "__main__":
    import sys
    success = check_top_scorers_quality()
